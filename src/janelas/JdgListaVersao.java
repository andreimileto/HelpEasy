...
public class JdgListaVersao extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lista de Versão");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdgListaVersao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JdgListaVersao dialog = new JdgListaVersao(new javax.swing.JFrame(), true);
