 ...
 * @author Mileto
 */
public class JdgPermissoesUsuario2OLD extends javax.swing.JDialog {

    Usuario usuario;
    ControleUsuario controleUsuario = new ControleUsuario();
    ArrayList<Usuario> usuarios;
    ArrayList<Usuario> permissoes;

    public JdgPermissoesUsuario2OLD(java.awt.Frame parent, boolean modal, Usuario usuario) {
        super(parent, modal);
        initComponents();
        this.usuario = usuario;
        UsuarioPermissaoTelaAcoes usuarioPermissaoTelaAcoes = new UsuarioPermissaoTelaAcoes();
        UsuarioPermissaoTela usuarioPermissoesTela = new UsuarioPermissaoTela();
        listarUsuarios();
    }

    public JdgPermissoesUsuario2OLD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
permissoes = usuarioDAO.listarTodos();
        for (int i = 0; i < permissoes.size(); i++) {
            System.out.println(permissoes.get(i).getId());
        }
...
//        dtm.addColumn("NOME2");
        ...
        for (int i = 0; i < usuarios.size(); i++) {
            ...
            dtm.addRow(new String[]{String.valueOf(permissoes.get(i).getId()),
                String.valueOf(permissoes.get(i).getId()), String.valueOf(permissoes.get(i).getId())});
        }
        return dtm;
    }
...
//        usuario.setSenha(usuarios.get(0).getSenha());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdgPermissoesUsuario2OLD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JdgPermissoesUsuario2OLD dialog = new JdgPermissoesUsuario2OLD(new javax.swing.JFrame(), true);
