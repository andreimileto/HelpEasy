 ...
 * @author Mileto
 */
public class JfmGrafico extends javax.swing.JFrame {

    /**
     * Creates new form JfmGrafico
     */
    public JfmGrafico() {
        initComponents();
...
//        Grafico.validate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfmGrafico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JfmGrafico().setVisible(true);
            }
        });
    }
